...
INSERT INTO lectionary_reflections
  (cycle, season, week, feast_key, lang, title, liturgical_color,
   gospel_ref, gospel_text, silence, meditative_phrase,
   inner_question, brief_prayer, spiritual_school, theme, updated_at)
VALUES (
  E'II', E'ordinary', 8, '', E'es',
  E'VIII Semana del Tiempo Ordinario — La autoridad de Jesús', E'green',
  ...
  E'Quédate en silencio un momento. ¿Desde qué autoridad estás viviendo hoy?', E'Tampoco yo os diré con qué autoridad hago estas cosas.',
  E'¿Hay algo en mi vida donde esquivo la verdad sobre Jesús, como los jefes del Templo evitaron responder?', E'Señor Jesús, dame la libertad de no buscar respuestas que me convengan, sino de acoger tu autoridad con fe sencilla. Amén.',
  E'bernardina', E'autoridad', NOW()
)
...
INSERT INTO lectionary_reflections
  (cycle, season, week, feast_key, lang, title, liturgical_color,
   ...
   inner_question, brief_prayer, spiritual_school, theme, updated_at)
VALUES (
  E'II', E'ordinary', 8, '', E'en',
  E'Week 8 of Ordinary Time — The Authority of Jesus', E'green',
  E'Mk 11,27-33', E'And they come again to Jerusalem. And when he was walking in the temple, there come to him the chief priests and the scribes and the ancients, And they say to him: By what authority dost thou these things? And Jesus answering, said to them: The baptism of John, was it from heaven, or from men? Answer me. And they answering, say to Jesus: We know not. And Jesus answering, saith to them: Neither do I tell you by what authority I do these things.',
  E'Rest in silence for a moment. Under whose authority are you living today?', E'Neither do I tell you by what authority I do these things.',
  E'Is there something in my life where I, like the chief priests, avoid honestly answering Christ''s question?', E'Lord Jesus, free me from seeking only the answers that suit me. Let your authority be the ground I stand on. Amen.',
  E'bernardina', E'authority', NOW()
)
ON CONFLICT (cycle, season, week, feast_key, lang) DO UPDATE SET
  title = EXCLUDED.title, liturgical_color = EXCLUDED.liturgical_color,
  gospel_ref = EXCLUDED.gospel_ref, gospel_text = EXCLUDED.gospel_text,
